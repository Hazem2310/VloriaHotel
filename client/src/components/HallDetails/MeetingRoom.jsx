...
const MeetingRoom = () => {
  ...
  const handleBooking = async () => {
    if (!user) {
      navigate('/auth', { state: { from: '/halls/meeting-room' } });
      return;
    }
  ...
  if (loading) {
    return <div className={styles.loading}>Loading Meeting Room...</div>;
  }
      ...
      <div className={styles.container}>
        ...
        <div className={styles.infoSection}>
          <div className={styles.header}>
            <div>
              ...
              <div className={styles.hallMeta}>
                <span className={styles.metaItem}><span className={styles.icon}>🏛️</span>Meeting Room</span>
          ...
          <div className={styles.description}>
            ...
            <p>The Executive Meeting Room is a modern and professional space tailored for business meetings, presentations, and small conferences. It features a sleek conference table, comfortable seating, and advanced presentation tools including a large display screen and high-speed internet.</p>
            <p>The room is designed with a minimalist yet elegant style, ensuring a focused and productive environment. Through the booking system, users can specify the number of attendees, required equipment, and optional services such as catering or refreshments. A smart pricing system generates an estimated cost based on user needs, making the process efficient and user-friendly.</p>
          </div>
          ...
          <div className={styles.bookingSection}>
            ...
            <div className={styles.formGroup}>
              ...
              <input type="number" placeholder="Enter attendee count" value={bookingData.guestCount} onChange={(e) => handleBookingChange('guestCount', e.target.value)} max={hall.capacity} min="1" />
            </div>
            ...
            <div className={styles.servicesSection}>
              ...
              <div className={styles.servicesGrid}>
                ...
                {hall.catering_available && (<label className={styles.serviceCheckbox}><input type="checkbox" checked={selectedServices.catering} onChange={() => handleServiceToggle('catering')} /><span>Catering (+$50/person)</span></label>)}
            ...
            <div className={styles.priceSummary}>
              ...
              <div className={styles.priceBreakdown}>
                <div className={styles.priceRow}><span>Room Rental</span><span>${hall.price}</span></div>
                ...
                {selectedMealPackage && bookingData.guestCount && (
                  <div className={styles.priceRow}><span>Meal Package ({bookingData.guestCount} attendees)</span><span>${(mealPackages.find(p => p.package_id === selectedMealPackage)?.price_per_person || 0) * parseInt(bookingData.guestCount)}</span></div>
                )}
