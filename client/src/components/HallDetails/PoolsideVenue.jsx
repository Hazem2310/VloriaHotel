...
import styles from "./PoolsideVenue.module.css";
...
const PoolsideVenue = () => {
  ...
  const handleBooking = async () => {
    if (!user) {
      navigate('/auth', { state: { from: '/halls/poolside-venue' } });
      return;
    }
  ...
  if (loading) {
    return <div className={styles.loading}>Loading Poolside Venue...</div>;
  }
      ...
      <div className={styles.container}>
        ...
        <div className={styles.infoSection}>
          <div className={styles.header}>
            <div>
              ...
              <div className={styles.hallMeta}>
                <span className={styles.metaItem}><span className={styles.icon}>🌳</span>Outdoor Venue</span>
          ...
          <div className={styles.description}>
            ...
            <p>The Poolside Outdoor Venue offers a breathtaking open-air experience surrounded by scenic views and a relaxing atmosphere. With stylish lighting, natural elements, and a beautiful pool backdrop, this venue is perfect for evening events, parties, and romantic celebrations.</p>
            <p>The design focuses on blending nature with elegance, providing guests with a refreshing and memorable setting. Users can easily customize their booking by selecting guest capacity, catering options, and preferred setup styles. Pricing is dynamically calculated based on selections, ensuring flexibility and convenience.</p>
          </div>
          ...
          <div className={styles.bookingSection}>
            ...
            <div className={styles.priceSummary}>
              ...
              <div className={styles.priceBreakdown}>
                <div className={styles.priceRow}><span>Venue Rental</span><span>${hall.price}</span></div>
